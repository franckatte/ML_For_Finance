...
# load best model
lstm_vanilla = load_model('/Users/franckatteaka/Desktop/cours/Semester III/Courses Projects/Machine Learning/Code/models/best_vanilla_lstm10.hdf5')
...
# checkpoint
modelCheckpoint2 = ModelCheckpoint(filepath = '/Users/franckatteaka/Desktop/cours/Semester III/Courses Projects/Machine Learning/Code/models/best_stacked_lstm10.hdf5',  save_best_only = True)
...
# load best model
lstm_stacked = load_model('/Users/franckatteaka/Desktop/cours/Semester III/Courses Projects/Machine Learning/Code/models/best_stacked_lstm10.hdf5')
...
plot_yields(lstm_vanilla,X_test,y_test0,folder,'vanilla 10')
plot_yields(lstm_stacked,X_test,y_test0,folder,'stacked 10')
plot_yields(lstm_bidirect,X_test,y_test0,folder,'bidirect 10')
