...
def purge_CV(X,train_folds,test_folds,purge):
    '''
        ...
        Return
        ------------
        train indexes,test indexes (numpy array, numpy array): train and test indexes after purginging
    '''
...
def CPCV(X,n_split,n_folds,purge):
    ...
    for train_folds in train_groups:
        ...
        train_index, test_index = purge_CV(X2,train_folds,test_folds,purge)
