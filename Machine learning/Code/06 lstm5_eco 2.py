...
random_search1.best_score_ # 1.5057756704632371e-06
...
# checkpoint
modelCheckpoint1 = ModelCheckpoint(filepath = model_folder + 'best_vanilla_lstm.hdf5',  save_best_only = True)
...
# load best model
lstm_vanilla = load_model(model_folder + 'best_vanilla_lstm.hdf5')
...
random_search2.best_score_ # 1.0550489012978063e-06
...
# checkpoint
modelCheckpoint2 = ModelCheckpoint(filepath = model_folder + 'best_stacked_lstm.hdf5',  save_best_only = True)
...
# load best model
lstm_stacked = load_model(model_folder + 'best_stacked_lstm.hdf5')
...
random_search3.best_score_ # 1.4842195127352337e-05
...
# checkpoint
modelCheckpoint3 = ModelCheckpoint(filepath = model_folder + 'best_bidirectional_lstm.hdf5',  save_best_only = True)
...
# load best model
lstm_bidirect = load_model(model_folder + 'best_bidirectional_lstm.hdf5')
...
plot_yields(lstm_vanilla,X_test,y_test0,predictions_folder,'vanilla')
plot_yields(lstm_stacked,X_test,y_test0,predictions_folder,'stacked')
plot_yields(lstm_bidirect,X_test,y_test0,predictions_folder,'bidirect')
