...
model_folder = '/Users/franckatteaka/Desktop/cours/Semester III/Courses Projects/Machine Learning/Code/00 models/eco models/'
predictions_folder = '/Users/franckatteaka/Desktop/cours/Semester III/Courses Projects/Machine Learning/Code/00 figures/LSTM/eco models/predictions/'
train_test_folder = '/Users/franckatteaka/Desktop/cours/Semester III/Courses Projects/Machine Learning/Code/00 figures/LSTM/eco models/train_test/'
...
random_search1.best_score_ # 2.4840690027956672e-06
...
# checkpoint
modelCheckpoint1 = ModelCheckpoint(filepath = model_folder +'best_vanilla_lstm10 5 ahead.hdf5',  save_best_only = True)
...
# load best model
lstm_vanilla = load_model(model_folder + 'best_vanilla_lstm 10 5 ahead.hdf5')
...
random_search2.best_score_ # 6.399007601428565e-06
...
# checkpoint
modelCheckpoint2 = ModelCheckpoint(filepath = model_folder + 'best_stacked_lstm 10 5 ahead.hdf5',  save_best_only = True)
...
# load best model
lstm_stacked = load_model(model_folder + 'best_stacked_lstm 10 5 ahead.hdf5')
...
random_search3.best_score_ # 1.4793938506776336e-05
...
# checkpoint
modelCheckpoint3 = ModelCheckpoint(filepath = model_folder + 'best_bidirectional_lstm 10 5 ahead.hdf5',  save_best_only = True)
...
# load best model
lstm_bidirect = load_model(model_folder + 'best_bidirectional_lstm 10 5 ahead.hdf5')
...
plot_yields(lstm_vanilla,X_test,y_test0,predictions_folder,'vanilla 10 5 ahead')
plot_yields(lstm_stacked,X_test,y_test0,predictions_folder,'stacked 10 5 ahead')
plot_yields(lstm_bidirect,X_test,y_test0,predictions_folder,'bidirect 10 5 ahead')
